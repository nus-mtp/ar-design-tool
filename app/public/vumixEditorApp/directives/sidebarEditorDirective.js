(function() {
  angular.module('vumixEditorApp.directives')
    .directive('sidebarEditor', function($window) {
      ...
      tmpl += '       <span data-placement="bottom" title="" data-original-title="Maximise" class="panel-button maximise"><i class="fa fa-square-o"></i></span>';
      tmpl += '       <span data-placement="bottom" title="" data-original-title="Default View" class="panel-button equalise"><i class="fa fa-server"></i></span>';
      tmpl += '     </div>';
      ...
      tmpl += '       <span class="panel-button addModel" data-toggle="modal" data-target="#add-asset-to-local"><i class="fa fa-plus-square"></i></span>';
      ...
      tmpl += '       <span data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Default View" class="panel-button equalise"><i class="fa fa-server"></i></span>';
      tmpl += '     </div>';
      tmpl += '     <div class="panel-body">';
      tmpl += '       <table class="table table-striped table-hover table-condensed">';
      tmpl += '         <thead>';
